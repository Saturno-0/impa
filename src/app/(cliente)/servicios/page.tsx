            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex justify-center gap-4 mb-10 p-1 bg-primary/10 dark:bg-primary/20 rounded-lg">
                    <button
                        ...
                        className={`w-full text-center font-semibold py-2 px-4 rounded-md transition-colors duration-300 ${service === 'sterilizacion'
                    ...
                    <button
                        ...
                        className={`w-full text-center font-semibold py-2 px-4 rounded-md transition-colors duration-300 ${service === 'platicas'
                                ? 'bg-primary text-background-dark'
                                : 'text-gray-700 dark:text-gray-300 hover:bg-primary/5'
                            }`}
                    >
